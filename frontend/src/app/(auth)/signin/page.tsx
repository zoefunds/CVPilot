    ...
    <div className="w-full max-w-[460px]">
          ...
          <div>
            <div className="flex items-baseline justify-between">
              ...
              <Link
                ...
                className="text-[12px] font-medium text-[#4b463f] underline underline-offset-4 hover:text-[#1c1c17]"
              >
                Forgot?
              </Link>
            </div>
      ...
      <ul className="mt-6 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[12px] text-[#7c766e]">
        <li className="flex items-center gap-1.5">
          ...
          Verifiable scoring on GenLayer
        </li>
        <li className="flex items-center gap-1.5">
          <Icon name="shield_check" size={14} className="text-[#1c1c17]" />
          Your wallet stays on this device
        </li>
      </ul>
    </div>
  );
