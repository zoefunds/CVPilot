"""
Replace passlib-based hashing in backend/app/core/security.py with direct
bcrypt calls. passlib 1.7.4 is unmaintained and incompatible with bcrypt 5.x.

bcrypt truncates secrets to 72 bytes (industry standard); we enforce that
explicitly to match Django/Devise behavior and avoid surprising users.
"""

from pathlib import Path

ROOT = Path("/Users/macbook/CVPilot")
TARGET = ROOT / "backend/app/core/security.py"
